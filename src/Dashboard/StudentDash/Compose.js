		...
		<>
			...
			<div className='bagc'>
				<div className='container'>
					<h2><div className='newf'>Compose your mail</div></h2>
					<hr className='md-6'/>
					<div className='container'>
						
						<Form method="POST" >
							<Form.Group controlId="subject"></Form.Group>
							<Form.Label><h6><div className='days'>Subject</div></h6></Form.Label>
							<Form.Control
							...
							<Form.Label ><h6>Write Here</h6></Form.Label>
							<FloatingLabel controlId="floatingTextarea" label="Write Here">
						...
						<Button variant='primary' onClick={handleSubmit} className='send' ><div className='days'>Send</div></Button>
					
						<Button variant='secondary' onClick={() => {navigate('/student', { state: { student_id: studentId, student_name: studentName } }) }} className='cancel'><div className='days'>Cancel</div></Button>
					</div>
        		</div>
				</div>
  			</div>
