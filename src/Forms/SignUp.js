	...
	return (
		<div>
			...
			<div className='justify-content-center'>
				...
				<FormContainer>
					<h2><div className='head1'>SignUp with Us</div></h2>
					...
					<Form method='POST'>
						...
						<Form.Label><div className='subhead1'><h5>College Name</h5></div></Form.Label>        
					...
					<Button variant='secondary' type='submit' onClick={onSignupClicked}><div className='head1'>SignUp</div></Button>
